...
import 'package:projeto_agenda/app/view/contact_form_back.dart';
...
class ContactForm extends StatelessWidget {
  ...
  Widget fieldEmail(ContactFormBack back) {
    return TextFormField(
        validator: (String? value) => back.validateEmail(value!),
  ...
  Widget fieldPhone(ContactFormBack back) {
    ...
    return TextFormField(
        validator: (String? value) => back.validatePhone(value!),
